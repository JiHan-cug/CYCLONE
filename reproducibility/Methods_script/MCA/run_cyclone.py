...
adata = adata_mca('../../data/MCA')

adata = data_preprocess(adata, batch_key='batch', label_key='celltype', select_hvg=2000, scale=True)
...
adata_corrd.write_h5ad('mca_cyclone_emb.h5ad')
