...
def my_func(adata):
    ...
    adata = scdml.preprocess(adata, batch_key="tech", cluster_method="louvain", resolution=3.0)
    scdml.integrate(adata, batch_key="tech", ncluster_list=[ncluster],
...
if __name__ == '__main__':
    ...
    adata_corrd.write_h5ad('pancreas_scdml_emb.h5ad')
